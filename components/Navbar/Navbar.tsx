  ...
  return (
    <View className='w-5/6 p-4 bg-black rounded-2xl absolute bottom-10 flex-row opacity-80 shadow'>
      <Pressable className='justify-center items-center flex-1'>
        <Icon name="home" size={30} color={screen === "home" ? "#fff" : "#383838"}/>
      </Pressable>
      <Pressable className='justify-center items-center flex-1'>
        <Icon name="isv" size={30} color={screen === "library" ? "#fff" : "#383838"}/>
      </Pressable>
      <Pressable className='justify-center items-center flex-1'>
        <Icon name="meh" size={30} color={screen === "profile" ? "#fff" : "#383838"}/>
      </Pressable>
    </View>
  )
}
